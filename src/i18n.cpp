...
static const wchar_t *kStringsEn[STR_COUNT] = {
    ...
    L"Tray password generator",
    L"Show a random password generator in the tray menu",
    L"Quick generate password hotkey",
    L"Copy a random password using the current generator settings",
    L"Light",
    L"Dark",
    L"Follow system",
    L"Classic",
